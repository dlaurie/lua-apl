...
GITFILES = apl.c apl-lib.lua apl-compiler.lua help.lua test.lua finnaplidiom.lua funclists.lua apl385.ttf lua-apl.xmodmap lctype-utf8.c lua-apl.c lua-apl.txt lua-apl.html prog-guide.html README.txt README.md Makefile
